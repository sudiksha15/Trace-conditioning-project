function image_projection(fileDir)
    %Code to create a max-min projection of images across filtered images.
    %Altered from Hua-an's roi_overlap_tbi.m code.

    if isempty(fileDir)
        filena%me_list = findNestedFiles('/mnt/HD_6TB/Kyle/ProcessedVideos/ali24_d2_s2', '"*MCrefImage.tif"')
    ...
    for filename_idx = 1:numel(filename_list)
        ...
        video_matrix = tiffs2matrix('m_f_', 1, 0);
