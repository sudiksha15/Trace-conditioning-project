...
%Selected Files
%File 1
base1 = '/mnt/eng_handata/Kyle_Hansen/AliEyeBlink/ali25_d4_s1/';
trace1 = 'trace_kyleFinalwDoughnut_AllBGs.mat';
image1name = 'full_projection_m_f_max_min_batch.fig';
save1 = 'trace_kyleFinalwDoughnut_AllBGs_matched.mat';
file1 = fullfile(base1, trace1);
image1 = fullfile(base1, image1name);
file1save = fullfile(base1, save1);
%File 2
base2 = '/mnt/eng_research_handata/Kyle/AliEyeBlink/ali26_d5_s2/';
trace2 = 'trace_kyleFinalwDoughnut_AllBGs.mat';
...
%Fields Out
field1name = 'lastTraining_d5_s1_index'; %'baseline_d2_s1_index';
field2name = 'firstExtinction_d5_s2_index'; %'firstExtinction_d5_s2_index';
